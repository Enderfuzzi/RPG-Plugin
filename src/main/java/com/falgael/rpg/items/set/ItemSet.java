...
public enum ItemSet implements NameBuilding,Set {
    ...
    ItemSet(Proficiency proficiency, Rarity rarity, int numberOfParts, ItemConfiguration configuration, String... description) {
        this(List.of(proficiency), rarity, numberOfParts, configuration, description);
    }

    ItemSet(List<Proficiency> proficiency, Rarity rarity, int numberOfParts, ItemConfiguration configuration, String... description) {
