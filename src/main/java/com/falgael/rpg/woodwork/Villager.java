...
public class Villager extends MainVillagerDefinition {
    ...
    public List<VillagerInstance> getVillager() {
        ...
        result.add(
                new VillagerInstance.VillagerBuilder("Carpenter 1", org.bukkit.entity.Villager.Profession.CARTOGRAPHER)
                        ...
                        .add(new MerchantRecipeBuilder(Items.SILVER_COIN.getItem()).addIngredients(new ItemStack(Material.CHERRY_LOG,16)).create())
                        .add(new MerchantRecipeBuilder(Items.SILVER_COIN.getItem()).addIngredients(new ItemStack(Material.CRIMSON_STEM,16)).create())
                        .add(new MerchantRecipeBuilder(Items.SILVER_COIN.getItem()).addIngredients(new ItemStack(Material.JUNGLE_LOG,16)).create())
                        .add(new MerchantRecipeBuilder(Items.SILVER_COIN.getItem()).addIngredients(new ItemStack(Material.MANGROVE_LOG,16)).create())
                        .add(new MerchantRecipeBuilder(Items.SILVER_COIN.getItem()).addIngredients(new ItemStack(Material.OAK_LOG,16)).create())
    ...
    /*
                  ...
                  .add(new MerchantRecipeBuilder(new ItemStack(Material.CHERRY_SAPLING,32)).addIngredients(Items.SILVER_COIN.getItem()).create())
                  .add(new MerchantRecipeBuilder(new ItemStack(Material.CRIMSON_FUNGUS,32)).addIngredients(Items.SILVER_COIN.getItem()).create())
                  .add(new MerchantRecipeBuilder(new ItemStack(Material.CRIMSON_NYLIUM,16)).addIngredients(Items.SILVER_COIN.getItem()).create())
                  .add(new MerchantRecipeBuilder(new ItemStack(Material.JUNGLE_SAPLING,32)).addIngredients(Items.SILVER_COIN.getItem()).create())
                  .add(new MerchantRecipeBuilder(new ItemStack(Material.MANGROVE_PROPAGULE,32)).addIngredients(Items.SILVER_COIN.getItem()).create())
                  .add(new MerchantRecipeBuilder(new ItemStack(Material.OAK_SAPLING,32)).addIngredients(Items.SILVER_COIN.getItem()).create())
                  .add(new MerchantRecipeBuilder(new ItemStack(Material.SPRUCE_SAPLING,32)).addIngredients(Items.SILVER_COIN.getItem()).create())
